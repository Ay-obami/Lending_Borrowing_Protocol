...
contract Pool is Ownable, ReentrancyGuard {
    ...
    function setReserveActive(string memory reserveName, bool active)
        external
        onlyOwner
    ...
    function _borrow(
        ...
        emit Borrow(msg.sender, assetTobeBorrowedData.reserveName, collateralData.reserveName, amount, collateralToLock, positionId);
    }
    ...
    function _repay(
        ...
        emit Repay(msg.sender, assetTobeBorrowedData.reserveName, collateralData.reserveName, repayAmount, collateralToRelease, positionId);
    ...
    function getUtilizationRate(string memory reserveName)
        public
        view
        reserveExists(reserveName)
        returns (uint256)
